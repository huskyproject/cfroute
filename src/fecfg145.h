/********************************************************/
/* 'C' Structures of FastEcho 1.45a                     */
/* Copyright (c) 1995 by Tobias Burchhardt              */
/* Last update: 22 Oct 1995                             */
/********************************************************/
...
typedef struct
{
 ...
 struct
 {
  ...
  byte packpriority     : 1;    /* system has priority packing ARCmail   */
  byte resv             : 2;
 } flags;                       /* 24 bits total !                       */
 struct
 {
...
#define EH_PB212_MSG    0x0107  /* See BBS package's documentation */
