...
#ifdef NEED_RECODING
	recodeToTransportCharset(headerin.ToUserName);
#endif
	fwrite (&headerin.ToUserName,1,strlen (headerin.ToUserName)+1,out);
#ifdef NEED_RECODING
	recodeToTransportCharset(headerin.FromUserName);
#endif
...
#ifdef NEED_RECODING
	recodeToTransportCharset(NoPathSubject);
#endif
...
#ifdef NEED_RECODING
			recodeToTransportCharset(buffer);
#endif
